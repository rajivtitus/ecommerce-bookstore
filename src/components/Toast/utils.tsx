import { RequiredToastProps } from "../../utils/types";
...
export const closeButtonClasses =
	"w-4 h-4 mx-3 items-center justify-center text-gray-400 hover:text-gray-900 rounded-md focus:ring-2 focus:ring-gray-300 inline-flex";
...
export const getIcon = (type: RequiredToastProps["type"]) => {
	// This code is equivalent to a Switch
	return {
		info: (
			<svg
				aria-hidden="true"
